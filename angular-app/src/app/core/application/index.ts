...
export { DecoratorInterpreterFactory } from './decorator/helpers/interpreter/decorator-interpreter-factory';
...
export { IApplicationStrategyFactory } from './strategies/factories/abstracts/interface-application-factory';
